...
class TestDocInfo {
  ...
  /// The limitations of teh pdf library used for creating test documents.
  /// (https://github.com/DavBfr/dart_pdf)

  /// 1) The producer field will omitted, since the library uses this field to
  /// set/append the link to its github repo.

  /// Similarly, the library, does not allow to set the createdTime explicitly,
  /// instead it calls DateTime.now(), preprocesses the result and uses it
  /// to save in the document being created,
  ...
  /// For this reasons comparison of createdDate will be omitted too.

  TestDocInfo({this.title, this.author, this.creator, this.subject, this.keywords});
  ...
  @override
  String toString() {
    return 'DocInfo{title: $title, author: $author, creator: $creator, subject: $subject, keywords: $keywords}';
  }
